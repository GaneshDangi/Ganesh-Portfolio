  ...
  projects: [
    {
      id: 1,
      caption:
        "It’s an Chatbot that understands what someone ask questions it replies like User-Friendly.",
      photos: ["/gallery/p1.jpg", "/gallery/p2.jpg"],
    },
    
    {
      id: 1,
      caption:
        "📂PitchDeck - Smart pitchdeck video on Shuttle Badminton using 12 AI Tools",
      photos: ["/gallery/pitchdeck1.jpg", "/gallery/pitchdeck2.jpg","/gallery/pitchdeck3.jpg", "/gallery/pitchdeck4.jpg"],
    },
  ],
  achievements: [
    {
      id: 1,
      caption: "Completition of 13 Courses 🏆!",
      photos: ["/gallery/Nxtwave.jpeg"],
    },
    {
      id: 2,
      caption: "Daytime Builder at Nxtwave🤖",
      photos: ["/gallery/Daytimecoder.jpeg"],
    },
  ],
};
